                        ...
                        {[1, 2, 3].map((_, i) => (
                            <div key={i} className="flex justify-between items-center border-b border-white/5 pb-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="font-medium text-sm">Venue Booking</p>
                                        <p className="text-xs text-muted-foreground">High Tech Auditorium</p>
                                    </div>
                                </div>
                                <span className="font-bold text-red-400">-₹5,000</span>
                            </div>
                        ))}
                    </div>
                </div>
